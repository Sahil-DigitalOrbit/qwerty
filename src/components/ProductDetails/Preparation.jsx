    ...
    return (
        <div className='relative bg-[#FFF5E7] lg:my-20 lg:py-20 my-10 py-10 '>
          ...
          <div className='hidden lg:block absolute -top-10 right-32 rotate-[60deg] w-[320px] h-[130px] '>
            <img className='w-full h-full object-cover bg-cover filter brightness-0 invert-[0.4] sepia-[2] saturate-[1] hue-rotate-[30deg] opacity-90' src={ReviewImg} alt="" />
          </div>
