...
export const OrdersCard = ({product}) => {
    return (
            ...
            <div className='flex flex-col gap-1 lg:w-[240px] md:w-[220px] w-[140px] transition-transform duration-300 ease-in'>
                <Link to={`/${product.id}`}>
                    <div className='lg:w-[240px] lg:h-[280px] md:w-[220px] md:h-[250px] w-[140px] h-[168px]'>
                        <img className='w-full h-full object-cover' src={product.image[0]} alt='' />
                    </div>
                </Link>
                ...
                <div className='flex items-center justify-between lg:w-[240px] md:w-[100%] w-[140px] lg:text-[18px] md:text-[14px] text-[11px] gap-3'>
                    <button className='w-1/2  bg-headerText text-white py-2 h-full border-2 border-headerText'>Reorder</button>
                    <button className='w-1/2 border-2 border-headerText  text-headerText p-2'>Rate</button>
                </div>
            </div>
        </div>
    )
